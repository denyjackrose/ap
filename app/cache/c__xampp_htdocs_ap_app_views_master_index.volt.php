<?php 
	$ctrlname = $this->router->getActionName();
	$ctrlname = str_replace('-', ' ', $ctrlname);
	$ctrlname = str_replace('_', ' ', $ctrlname); 
	$ctrlname = ucwords(strtolower($ctrlname));
?>
...
<head>
  ...
  <?= $this->tag->stylesheetLink('assets/plugins/pace/pace-theme-flash.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/bootstrapv3/css/bootstrap.min.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/font-awesome/css/font-awesome.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/jquery-scrollbar/jquery.scrollbar.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/select2/css/select2.min.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/switchery/css/switchery.min.css') ?> <?= $this->tag->stylesheetLink('pages/css/pages-icons.css') ?> <?= $this->tag->stylesheetLink('pages/css/pages.css') ?> <?= $this->tag->stylesheetLink('assets/css/style.css') ?> <?= $this->tag->stylesheetLink('sweetalert/sweetalert.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/jquery-datatable/media/css/dataTables.bootstrap.min.css') ?> <?= $this->tag->stylesheetLink('assets/plugins/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css') ?>
  <?= $this->tag->stylesheetLink('assets/plugins/datatables-responsive/css/datatables.responsive.css') ?>
  <!-- BEGIN VENDOR JS -->

  <!--[if lte IE 9]>
	<?= $this->tag->stylesheetLink('assets/plugins/codrops-dialogFx/dialog.ie.css') ?>
	<![endif]-->
</head>
...
<body class="fixed-header horizontal-menu">
  ...
  <nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-overlay-slide from-top" id="appMenu">
      <div class="row">
        <div class="col-xs-6 no-padding">
          <a href="#" class="p-l-40">
			 <?= $this->tag->image(['assets/img/demo/social_app.svg']) ?>
            </a>
        </div>
        <div class="col-xs-6 no-padding">
          <a href="#" class="p-l-10">
			 <?= $this->tag->image(['assets/img/demo/email_app.svg']) ?>
            </a>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6 m-t-20 no-padding">
          <a href="#" class="p-l-40">
			 <?= $this->tag->image(['assets/img/demo/calendar_app.svg']) ?>
            </a>
        </div>
        <div class="col-xs-6 m-t-20 no-padding">
          <a href="#" class="p-l-10">
			 <?= $this->tag->image(['assets/img/demo/add_more.svg']) ?>
    ...
    <div class="sidebar-header">
      <?= $this->tag->image(['assets/img/logo_white.png', ['class' => 'brand']]) ?>
    ...
    <div class="sidebar-menu">
      ...
      <ul class="menu-items">
        ...
        <li>
          ...
          <ul class="sub-menu">
            <li class="">
              <a href="<?= $this->url->get('master/agama') ?>">Agama</a>
              <span class="icon-thumbnail">A</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/akses_masuk') ?>">Akses Masuk</a>
              <span class="icon-thumbnail">A</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/diagnosa') ?>">Diagnosa</a>
              <span class="icon-thumbnail">D</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/dokter') ?>">Dokter</a>
              <span class="icon-thumbnail">D</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/dokter_poli') ?>">Dokter Poli</a>
              <span class="icon-thumbnail">D</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/fasilitas_penunjang') ?>">Fasilitas Penunjang</a>
              <span class="icon-thumbnail">F</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/golongan_dokter') ?>">Golongan Dokter</a>
              <span class="icon-thumbnail">G</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/instalasi') ?>">Instalasi</a>
              <span class="icon-thumbnail">I</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/kecamatan') ?>">Kecamatan</a>
              <span class="icon-thumbnail">K</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/kelurahan') ?>">Kelurahan</a>
              <span class="icon-thumbnail">K</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/kota') ?>">Kota</a>
              <span class="icon-thumbnail">K</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/negara') ?>">Negara</a>
              <span class="icon-thumbnail">N</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/pegawai') ?>">Pegawai</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/pekerjaan') ?>">Pekerjaan</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/penjamin') ?>">Penjamin</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/poli') ?>">Poli</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/provinsi') ?>">Provinsi</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/rawat_jalan') ?>">Rawat Jalan</a>
              <span class="icon-thumbnail">R</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/spesialisasi') ?>">Spesialisasi</a>
              <span class="icon-thumbnail">S</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/suku_bangsa') ?>">Suku Bangsa</a>
              <span class="icon-thumbnail">S</span>
            </li>
            <li class="">
              <a href="<?= $this->url->get('master/tindakan') ?>">Tindakan</a>
  ...
  <div class="page-container ">
    ...
    <div class="header ">
        ...
        <div class="pull-center hidden-md hidden-lg">
          <div class="header-inner">
            <div class="brand inline">
              <?= $this->tag->image(['assets/img/logoMpm.png', 'height' => '50px']) ?>
            </div>
          </div>
        </div>
        <!-- RIGHT SIDE -->
      ...
      <div class=" pull-left sm-table hidden-xs hidden-sm">
        <div class="header-inner">
          <div class="brand inline">
            <?= $this->tag->image(['assets/img/logoMpm.png', 'height' => '50']) ?>
          </div>
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            ...
                            <?= $this->tag->image(['assets/img/profiles/1x.jpg']) ?>
                          </div>
                          <a href="#" class="text-complete pull-left">
      ...
      <div class=" pull-right">
        <div class="header-inner">
          <a href="#" class="btn-link icon-set menu-hambuger-plus m-l-20 sm-no-margin hidden-sm hidden-xs" data-toggle="quickview"
        ...
        <div class="visible-lg visible-md m-t-10">
          ...
          <div class="dropdown pull-right">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<?= $this->tag->image(['assets/img/profiles/avatar.jpg']) ?>
</span>
              </button>
...
<div class="row">
	<section id="area">
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/diagnosa') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_diagnosa.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Diagnosa</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/negara') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_negara.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Negara</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/provinsi') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_provinsi.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Provinsi</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/kota') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_kota.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Kota</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/kecamatan') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_kecamatan.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Kecamatan</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/kelurahan') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_kelurahan.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Kelurahan</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/agama') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_agama.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Agama</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/pekerjaan') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_pekerjaan.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Pekerjaan</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/instalasi') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_instalasi.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Instalasi</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/poli') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_poli.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Poli</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/fasilitas_penunjang') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_fasilitaspenunjang.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Fasilitas Penunjang</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/penjamin') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_penjamin.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Penjamin</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/spesialisasi') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">

						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_spesialis.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Spesialisasi</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/rujuk') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_rujuk.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Rujuk</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/golongan_dokter') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_golongandokter.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Golongan Dokter</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/pegawai') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_pegawai.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Pegawai</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/dokter_poli') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_dokterpoli.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Setup Dokter</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/pasien') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_pasien.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Pasien</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('tarif') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_tarif.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Tarif</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_ranap') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_ranap.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Rawat Inap</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_tindakan/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_element_tindakan.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Tindakan</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_inventory') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_inventory.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Inventory</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_farmasi/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_farmasi.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Farmasi</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_akuntansi/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_akuntansi.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Akuntansi</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_keuangan/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_keuangan.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element PMD / Keuangan</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_ulp/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_cash_in_hand.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element ULP</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_anggaran/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_anggaran.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Anggaran</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_rekam_medis/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_medical_record.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Rekam Medis</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('element_kuisioner/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_kuisioner.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text">Element Kuisioner</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
			<a href="<?= $this->url->get('master/') ?>">
				<div class="ar-1-1 bg-bd-white">
					<div class="widget-2 panel">
						<div class="panel-body">
							<div class="db-menu">
								<?= $this->tag->image(['img/icon/ic_.png']) ?>
							</div>
							<div class="pull-bottom bottom-left bottom-right padding-5">
								<h5 class="db-text"></h5>
							</div>
            ...
            <ul>
              ...
              <li data-noteid="1">
                <div class="left">
                  ...
                  <p class="note-preview">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                ...
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
						<?= $this->tag->image(['assets/img/profiles/8x.jpg']) ?>
                             </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
 ...
 <!-- BEGIN VENDOR JS -->
  <?= $this->tag->javascriptInclude('assets/plugins/pace/pace.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery/jquery-1.11.1.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/modernizr.custom.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-ui/jquery-ui.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/bootstrapv3/js/bootstrap.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery/jquery-easy.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-unveil/jquery.unveil.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-bez/jquery.bez.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-ios-list/jquery.ioslist.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-actual/jquery.actual.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/select2/js/select2.full.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/classie/classie.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/switchery/js/switchery.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-datatable/media/js/jquery.dataTables.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-datatable/media/js/dataTables.bootstrap.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/datatables-responsive/js/datatables.responsive.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/datatables-responsive/js/lodash.min.js') ?>
  ...
  <?= $this->tag->javascriptInclude('assets/js/tables.js') ?> 
  <?= $this->tag->javascriptInclude('assets/js/datatables.js') ?> <?= $this->tag->javascriptInclude('assets/plugins/jquery-datatable/extensions/Scroller/js/dataTables.scroller.js') ?>
  <!-- END PAGE LEVEL JS -->
