...
<div class="row">
				<section id="area">
					<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
						<a href="<?= $this->url->get('element_ranap/bor') ?>">
							<div class="ar-1-1 bg-bd-white" >
								<div class="widget-2 panel">
									<div class="panel-body">
										<div class="db-menu">
										<?= $this->tag->image(['img/icon/ic_bor.png']) ?>
										</div>
					...
					<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
						<a href="<?= $this->url->get('element_ranap/gedung') ?>">
							<div class="ar-1-1 bg-bd-white" >
								<div class="widget-2 panel">
									<div class="panel-body">
										<div class="db-menu">
										<?= $this->tag->image(['img/icon/ic_gedung.png']) ?>
										</div>
										<div class="pull-bottom bottom-left bottom-right padding-5">
					...
					<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
						<a href="<?= $this->url->get('element_ranap/kelas') ?>">
							<div class="ar-1-1 bg-bd-white" >
								<div class="widget-2 panel">
									<div class="panel-body">
										<div class="db-menu">
										<?= $this->tag->image(['img/icon/ic_kelas.png']) ?>
										</div>
										<div class="pull-bottom bottom-left bottom-right padding-5">
					...
					<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
						<a href="<?= $this->url->get('element_ranap/lantai') ?>">
							<div class="ar-1-1 bg-bd-white" >
								<div class="widget-2 panel">
									<div class="panel-body">
										<div class="db-menu">
										<?= $this->tag->image(['img/icon/ic_lantai.png']) ?>
										</div>
										<div class="pull-bottom bottom-left bottom-right padding-5">
					...
					<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
						<a href="<?= $this->url->get('element_ranap/ruang_ok/') ?>">
							<div class="ar-1-1 bg-bd-white" >
								<div class="widget-2 panel">
									<div class="panel-body">
										<div class="db-menu">
										<?= $this->tag->image(['img/icon/ic_ruangok.png']) ?>
										</div>
										<div class="pull-bottom bottom-left bottom-right padding-5">
					...
					<div class="col-sm-4 col-xs-6 col-md-3 col-lg-2 m-b-20">
						<a href="<?= $this->url->get('element_ranap/ruang_rawat/') ?>">
							<div class="ar-1-1 bg-bd-white" >
								<div class="widget-2 panel">
									<div class="panel-body">
										<div class="db-menu">
										<?= $this->tag->image(['img/icon/ic_ruangrawat.png']) ?>
										</div>
										<div class="pull-bottom bottom-left bottom-right padding-5">
