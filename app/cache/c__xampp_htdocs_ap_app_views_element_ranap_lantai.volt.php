...
<form name="frmlt" id="frmlt" method="post" class="frmlt" onsubmit="register();return false;" enctype="multipart/form-data">
	<div class="col-sm-12">
		<!-- START PANEL -->
					...
					<div class="col-sm-12">
						<div class="col-sm-6">
						  <div class="form-group form-group-default">
							...
							<input type="text" name="txtltid" placeholder="" class="form-control" required>
						  </div>
						</div>
						<div class="col-sm-6">
						  <div class="form-group form-group-default">
							<label>Nama Lantai</label>
							<input type="text" name="txtltnama" placeholder="" class="form-control" required>
						  </div>
						</div> 
