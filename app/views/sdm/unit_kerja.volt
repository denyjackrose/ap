...
<div class="modal fade fill-in" style="background:#fff!important" id="myModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-dialog " style="width: 100%!important;">
                  ...
                  <div class="modal-header clearfix text-left">
                    ...
                    <h5><span class="bold">Unit Kerja</span></h5>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-12">
								...
								<label class="">Direktorat</label>	
									<select id="getuk" class="full-width" data-placeholder="Pilih Direktorat" data-init-plugin="select2">
									<option value=""></option> 
									<option value="1">Direktorat Utama</option>
									<option value="2">Direktorat Keuangan</option>
									</select>
								  </div>
								</div>
							...
							<div class="col-sm-12">
								...
								<div class="col-sm-6">
									<div class="form-group required">
										<label>Flag Unit Kerja </label>
										<div class="radio radio-success">
										
											  <input type="radio" value="smf" name="opsiunit" id="smf">
											  <label for="smf">SMF</label>
											  <input type="radio" checked="checked" value="ranap" name="opsiunit" id="ranap">
