							...
							<div class="col-sm-12">
								<div class="col-sm-6">
								  <div class="form-group form-group-default">
									<label>NM Tindakan Periksa</label>
									<input type="text" name="txtnnmtindakanperiksa" placeholder="" class="form-control" required>
								  </div>
								</div>
								<div class="col-sm-6">
								 <div class="form-group form-group-default">
									<label>Kriteria</label>
									<input type="text" name="txtkriteria" placeholder="" class="form-control" required>
								  </div>
								</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="col-sm-6">
								  <div class="form-group form-group-default">
									<label>Jenis</label>
									<input type="text" name="txtjenis" placeholder="" class="form-control" required>
								  </div>
								</div> 
								<div class="col-sm-6">
