...
<head>
  ...
  {{ stylesheet_link('assets/plugins/pace/pace-theme-flash.css') }} {{ stylesheet_link('assets/plugins/bootstrapv3/css/bootstrap.min.css')
  }} {{ stylesheet_link('assets/plugins/font-awesome/css/font-awesome.css') }} {{ stylesheet_link('assets/plugins/jquery-scrollbar/jquery.scrollbar.css')
  }} {{ stylesheet_link('assets/plugins/select2/css/select2.min.css') }} {{ stylesheet_link('assets/plugins/switchery/css/switchery.min.css')
  }} {{ stylesheet_link('pages/css/pages-icons.css') }} {{ stylesheet_link('pages/css/pages.css') }} {{ stylesheet_link('assets/css/style.css')
  }} {{ stylesheet_link('sweetalert/sweetalert.css') }} {{ stylesheet_link('assets/plugins/jquery-datatable/media/css/dataTables.bootstrap.min.css')
  }} {{ stylesheet_link('assets/plugins/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css') }}
  {{ stylesheet_link('assets/plugins/datatables-responsive/css/datatables.responsive.css') }}
  <!-- BEGIN VENDOR JS -->

  <!--[if lte IE 9]>
	{{ stylesheet_link('assets/plugins/codrops-dialogFx/dialog.ie.css') }}
	<![endif]-->
</head>
...
<body class="fixed-header horizontal-menu">
  ...
  <nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-overlay-slide from-top" id="appMenu">
      <div class="row">
        <div class="col-xs-6 no-padding">
          <a href="#" class="p-l-40">
			 {{ image('assets/img/demo/social_app.svg') }}
            </a>
        </div>
        <div class="col-xs-6 no-padding">
          <a href="#" class="p-l-10">
			 {{ image('assets/img/demo/email_app.svg') }}
            </a>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6 m-t-20 no-padding">
          <a href="#" class="p-l-40">
			 {{ image('assets/img/demo/calendar_app.svg') }}
            </a>
        </div>
        <div class="col-xs-6 m-t-20 no-padding">
          <a href="#" class="p-l-10">
			 {{ image('assets/img/demo/add_more.svg') }}
    ...
    <div class="sidebar-header">
      {{ image('assets/img/logo_white.png', ['class': 'brand']) }}
    ...
    <div class="sidebar-menu">
      ...
      <ul class="menu-items">
        ...
        <li>
          ...
          <ul class="sub-menu">
            <li class="">
              <a href="{{ url('master/agama') }}">Agama</a>
              <span class="icon-thumbnail">A</span>
            </li>
            <li class="">
              <a href="{{ url('master/akses_masuk') }}">Akses Masuk</a>
              <span class="icon-thumbnail">A</span>
            </li>
            <li class="">
              <a href="{{ url('master/diagnosa') }}">Diagnosa</a>
              <span class="icon-thumbnail">D</span>
            </li>
            <li class="">
              <a href="{{ url('master/dokter') }}">Dokter</a>
              <span class="icon-thumbnail">D</span>
            </li>
            <li class="">
              <a href="{{ url('master/dokter_poli') }}">Dokter Poli</a>
              <span class="icon-thumbnail">D</span>
            </li>
            <li class="">
              <a href="{{ url('master/fasilitas_penunjang') }}">Fasilitas Penunjang</a>
              <span class="icon-thumbnail">F</span>
            </li>
            <li class="">
              <a href="{{ url('master/golongan_dokter') }}">Golongan Dokter</a>
              <span class="icon-thumbnail">G</span>
            </li>
            <li class="">
              <a href="{{ url('master/instalasi') }}">Instalasi</a>
              <span class="icon-thumbnail">I</span>
            </li>
            <li class="">
              <a href="{{ url('master/kecamatan') }}">Kecamatan</a>
              <span class="icon-thumbnail">K</span>
            </li>
            <li class="">
              <a href="{{ url('master/kelurahan') }}">Kelurahan</a>
              <span class="icon-thumbnail">K</span>
            </li>
            <li class="">
              <a href="{{ url('master/kota') }}">Kota</a>
              <span class="icon-thumbnail">K</span>
            </li>
            <li class="">
              <a href="{{ url('master/negara') }}">Negara</a>
              <span class="icon-thumbnail">N</span>
            </li>
            <li class="">
              <a href="{{ url('master/pegawai') }}">Pegawai</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="{{ url('master/pekerjaan') }}">Pekerjaan</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="{{ url('master/penjamin') }}">Penjamin</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="{{ url('master/poli') }}">Poli</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="{{ url('master/provinsi') }}">Provinsi</a>
              <span class="icon-thumbnail">P</span>
            </li>
            <li class="">
              <a href="{{ url('master/rawat_jalan') }}">Rawat Jalan</a>
              <span class="icon-thumbnail">R</span>
            </li>
            <li class="">
              <a href="{{ url('master/spesialisasi') }}">Spesialisasi</a>
              <span class="icon-thumbnail">S</span>
            </li>
            <li class="">
              <a href="{{ url('master/suku_bangsa') }}">Suku Bangsa</a>
              <span class="icon-thumbnail">S</span>
            </li>
            <li class="">
              <a href="{{ url('master/tindakan') }}">Tindakan</a>
  ...
  <div class="page-container ">
    ...
    <div class="header ">
        ...
        <div class="pull-center hidden-md hidden-lg">
          <div class="header-inner">
            <div class="brand inline">
              {{ image('assets/img/logoMpm.png', 'height': '50px') }}
            </div>
          </div>
        </div>
        <!-- RIGHT SIDE -->
      ...
      <div class=" pull-left sm-table hidden-xs hidden-sm">
        <div class="header-inner">
          <div class="brand inline">
            {{ image('assets/img/logoMpm.png', 'height': '50') }}
          </div>
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            ...
                            {{ image('assets/img/profiles/1x.jpg') }}
                          </div>
                          <a href="#" class="text-complete pull-left">
        ...
        <div class="visible-lg visible-md m-t-10">
          ...
          <div class="dropdown pull-right">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				{{ image('assets/img/profiles/avatar.jpg') }}
</span>
              </button>
                ...
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
						{{ image('assets/img/profiles/8x.jpg') }}
                             </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
 ...
 <!-- BEGIN VENDOR JS -->
  {{ javascript_include('assets/plugins/pace/pace.min.js') }} {{ javascript_include('assets/plugins/jquery/jquery-1.11.1.min.js')
  }} {{ javascript_include('assets/plugins/modernizr.custom.js') }} {{ javascript_include('assets/plugins/jquery-ui/jquery-ui.min.js')
  }} {{ javascript_include('assets/plugins/bootstrapv3/js/bootstrap.min.js') }} {{ javascript_include('assets/plugins/jquery/jquery-easy.js')
  }} {{ javascript_include('assets/plugins/jquery-unveil/jquery.unveil.min.js') }} {{ javascript_include('assets/plugins/jquery-bez/jquery.bez.min.js')
  }} {{ javascript_include('assets/plugins/jquery-ios-list/jquery.ioslist.min.js') }} {{ javascript_include('assets/plugins/jquery-actual/jquery.actual.min.js')
  }} {{ javascript_include('assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js') }} {{ javascript_include('assets/plugins/select2/js/select2.full.min.js')
  }} {{ javascript_include('assets/plugins/classie/classie.js') }} {{ javascript_include('assets/plugins/switchery/js/switchery.min.js')
  }} {{ javascript_include('assets/plugins/jquery-datatable/media/js/jquery.dataTables.min.js') }} {{ javascript_include('assets/plugins/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js')
  }} {{ javascript_include('assets/plugins/jquery-datatable/media/js/dataTables.bootstrap.js') }} {{ javascript_include('assets/plugins/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js')
  }} {{ javascript_include('assets/plugins/datatables-responsive/js/datatables.responsive.js') }} {{ javascript_include('assets/plugins/datatables-responsive/js/lodash.min.js')
  }}
  ...
  {{ javascript_include('assets/js/tables.js') }} 
  {{ javascript_include('assets/js/datatables.js')
  }} {{ javascript_include('assets/plugins/jquery-datatable/extensions/Scroller/js/dataTables.scroller.js') }}
  <!-- END PAGE LEVEL JS -->
