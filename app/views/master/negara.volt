...
{% block content %}
<form name="frmNgra" id="frmNgra" method="post" class="frmNgra" onsubmit="register();return false;" enctype="multipart/form-data">
	<div class="col-sm-12">
		<!-- START PANEL -->
			...
			<div class="panel-body">
                ...
                <div class="col-sm-6">
                  <div class="form-group form-group-default">
                    <label>ID</label>
                    <input type="text" name="txtngra" placeholder="" class="form-control" required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group form-group-default">
