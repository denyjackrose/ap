              ...
              <div class="col-sm-12">
                <div class="col-sm-6">
                  <div class="form-group form-group-default">
                    <label>Nama Material Group</label>
                    <input type="text" name="txtnamamaterialgroup" placeholder="" class="form-control">
                  </div>
...
<div class="c-table">
  <table class="table table-bordered table-hover" id="tableWithSearch">
    ...
    <tbody>
      <tr class="no-m">
        <td class="v-align-middle">ALAT BALUT</td>
